...
void main() {
  ...
  testWidgets(
    'requests /api/discover_jobs/old and renders the returned listings',
    (tester) async {
  ...
  testWidgets('shows an empty state when there are no old listings', (
    tester,
  ) async {
    ApiClient.testClient = MockClient((request) async {
      return http.Response(jsonEncode([]), 200);
    ...
    (tester) async {
      ...
      ApiClient.testClient = MockClient((request) async {
        ...
        return http.Response(
          jsonEncode(callCount == 1 ? [] : expiredJobs),
          200,
        );
      });
  ...
  testWidgets('tapping an old listing opens DiscoverJobDetailScreen', (
    tester,
  ) async {
    ApiClient.testClient = MockClient((request) async {
      return http.Response(jsonEncode(expiredJobs), 200);
